...
The module exposes all 89 cumulative OpenCL 1.0 through 1.2 commands with V-style snake-case wrappers,
...
events, and an OpenCL 1.2 marker-with-wait-list dependency on PoCL.
